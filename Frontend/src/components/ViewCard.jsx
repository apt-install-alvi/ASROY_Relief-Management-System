    ...
    <div className="viewcard-body">
      ...
      {isEditing ? (
        <>
          <div className="edit-field">
            ...
            >
              ...
              {EVENT_TYPES.map((ev, idx) => <option key={idx} value={ev}>{ev}</option>)}
            </select>
          </div>
          ...
          <div className="edit-field">
            ...
            >
              ...
              {AREA_NAMES.map((areaName, idx) => <option key={idx} value={areaName}>{areaName}</option>)}
            </select>
          </div>
          ...
          <div className="edit-field">
            ...
            <input
              ...
              onChange={e => handleInputChange("isInactive", e.target.checked)}
            />
          </div>
        </>
      ) : (
        <>
          ...
          <p className="data"><span>Date: </span>{formatDateForDisplay(editData.date)}</p>
          <p className="data"><span>Time: </span>{formatTimeForDisplay(editData.time)}</p>
          <p className="data"><span>Status: </span>{editData.isInactive ? "Not Active" : "Active"}</p>
        </>
      )}
