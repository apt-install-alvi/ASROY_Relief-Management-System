...
export function ViewShelterCard({ shelterId, image, name, area, total_capacity, current_capacity, handleState, onSave }) {
  ...
  const handleSave = async () => {
    try {
      await axios.put(`http://localhost:5000/api/shelters/update/${shelterId}`, editData);
  ...
  const handleDelete = async () => {
    const confirmDelete = window.confirm("Are you sure you want to delete this shelter?");
